...
* {Exception Notifier}[http://github.com/smartinez87/exception_notification] Plugin to provides a mailer object for sending email notificactions when errors occur.
...
* {Episode 104 - Exception Notifications}[http://railscasts.com/episodes/104-exception-notifications]
